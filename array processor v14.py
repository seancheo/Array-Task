...
class Astring(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        BubbleB = tk.Button(self, text="Bubble", padx=20)  # Button for binary sort
        BubbleB.grid(row=11, column=1, sticky="es")
        LinearB = tk.Button(self, text="Linear", padx=20)  # Button for selection sort
        LinearB.grid(row=11, column=2, sticky="s")
        BinaryB = tk.Button(self, text="Binary", padx=20)  # Button for insertion sort
